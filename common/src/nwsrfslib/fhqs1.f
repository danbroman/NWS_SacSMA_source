...
!CP    IF (ITRACE.GE.3) WRITE(IODBUG,900)
...
C................................
C      DEBUG OUTPUT
!CP    990   IF (IBUG.EQ.0) GO TO 995
!CP    WRITE(IODBUG,901) ICONV,H,HA,ASHFT,Q,I1,I2,LL,
 990   IF ( FEWSDEBUG.LT.4 ) GO TO 995
       WRITE(MESSAGESTRING, 901) ICONV,H,HA,ASHFT,Q,I1,I2,LL,
...
!CP    IF (NCROSS.EQ.0) GO TO 995
!CP    WRITE(IODBUG,902) NCROSS,NRANGE,ABELOW,HESTIM,
       IF (NCROSS.EQ.0) GO TO 995 
       WRITE(MESSAGESTRING, 902) NCROSS,NRANGE,ABELOW,HESTIM,
     $                           (CARRYO(I),I=1,4)
       call logfromfortran(DEBUG_LEVEL, MESSAGESTRING) 
...
C................................
!CP    995   IF(ITRACE.GE.3) WRITE(IODBUG,903)
 995   IF ( FEWSDEBUG.GE.5 ) THEN
