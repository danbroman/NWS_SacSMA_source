...
C.......................................................................
C
CFC      IF(IB.EQ.1)WRITE(IODBUG,900)X1,X2,Y0,Y1,NP,XTA,CONK,QDT
      IF(FEWSDEBUG .GE. 1) THEN
      	WRITE(MESSAGESTRING,900)X1,X2,Y0,Y1,NP,XTA,CONK,QDT
...
C
      ...
      QDT=.FALSE.
C
CFC      IF(IB.EQ.1)WRITE(IODBUG,901)Y2
      IF(FEWSDEBUG .GE. 1) THEN
      	WRITE(MESSAGESTRING,901)Y2
	call logfromfortran(DEBUG_LEVEL,MESSAGESTRING)
      END IF       
