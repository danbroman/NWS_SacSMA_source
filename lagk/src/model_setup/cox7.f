...
C
!CP   DATA L3/4HL3  /
      CHARACTER*5 INDIMS, IUNIT
C
C
C  PRINT TRACE INFORMATION AND SET DEBUG PRINT FLAG
!CP   LTRACE=1
!CP   NOP=7
!CP   CALL FPRBUG (SNAME,LTRACE,NOP,IB)
C
C...........................
C
...
!CP   IF(IB.EQ.1)WRITE(IODBUG,605)I,K,J,CO(K),CO(J),LAG
!CP  605 FORMAT(11X,'IN DO 100 LOOP - I,K,J,CO(K),CO(J),LAG= ',3I5,2G10.3,
!CP  1  I3)
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,605)I,K,J,CO(K),CO(J),LAG
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
  605    FORMAT(11X,'IN DO 100 LOOP - I,K,J,CO(K),CO(J),LAG= ',3I5,
     1          2G10.3,I3)
      END IF
...
C
   80 TIME=CO(K) - FSERC7(LXXXX,CO(J),NPLQO,CONLQO)
     1           + FSERC7(LXXXX,CO(J),NPLQN,CONLQN)
C
!CP 90 IF(IB.EQ.1)WRITE(IODBUG,606)TIME
   90 IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,606)TIME
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C.......................................................................
C
!CP  110 IF(IB.EQ.1)WRITE(IODBUG,607)LAG,CN(2)
  110 IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,607)LAG,CN(2)
         call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
  180 TIME= 0.0  - FSERC7(LXXXX,CN(2),NPLQO,CONLQO)
     1           + FSERC7(LXXXX,CN(2),NPLQN,CONLQN)
C
!CP  190 IF(IB.EQ.1)WRITE(IODBUG,608)TIME
  190 IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,608)TIME
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
      ...
      NVAL=MXCON-LCNP3+1
      Z=0.
!CP   IF(IB.EQ.1)WRITE(IODBUG,609)LCNP3,NVAL
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,609)LCNP3,NVAL
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
!CP  195 IF(IB.EQ.1)WRITE(IODBUG,600)LCN,LAG
  195 IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,600)LCN,LAG
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C
      DTYPIN=PO(4)
!CP   CALL FDCODE(DTYPIN,STDUNT,INDIMS,MSNG,NUPDT,TSCALE,NEXTRA,IER)
      CALL getDimensionAndUnitInFortran(DTYPIN, INDIMS, IUNIT)
   
      MEANQO=.FALSE.
      IF(TRIM(INDIMS).EQ.'L3')MEANQO=.TRUE.
      DTYPIN=PN(4)
!CP   CALL FDCODE(DTYPIN,STDUNT,INDIMS,MSNG,NUPDT,TSCALE,NEXTRA,IER)
      CALL getDimensionAndUnitInFortran(DTYPIN, INDIMS, IUNIT)
      MEANQN=.FALSE.
      IF(TRIM(INDIMS).EQ.'L3')MEANQN=.TRUE.
C
!CP   IF(IB.EQ.1)WRITE(IODBUG,604)MEANQO,MEANQN
      IF ( FEWSDEBUG.GE.4 ) THEN
         WRITE(MESSAGESTRING,604)MEANQO,MEANQN
	 call logfromfortran(DEBUG_LEVEL, MESSAGESTRING)
...
C.......................................................................
C
!CP  300 IF(IB.NE.1)RETURN
  300 IF( FEWSDEBUG.LT.4 ) RETURN
C
      NPO=PO(16)
      NCO=CO(1)
      NPN=PN(16)
